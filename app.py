...
# ✅ Load content from local knowledge base file
def load_knowledge():
    try:
...
# 📌 TINA's strict system prompt with injected knowledge
...
SYSTEM_PROMPT = (
    ...
    "Base your answers strictly on publicly available resources like the NIRC, BIR Revenue Regulations (RRs), Revenue Memorandum Circulars (RMCs), official BIR issuances, "
    "and the following additional reference material:\n\n"
    + KNOWLEDGE +
...
def respond(message, history, system_message, max_tokens, temperature, top_p):
    try:
        tax_keywords = [
            "bir", "tax", "vat", "income", "1701", "2550", "0619",
            "withholding", "rdo", "tin", "philippine", "form", "compliance"
        ]
